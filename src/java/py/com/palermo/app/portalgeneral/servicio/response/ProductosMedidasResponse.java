 ...
 */
@XmlType(name = "ProductosMedidasResponse")
public class ProductosMedidasResponse {

    private int codRetorno;
    private ProductosMedidas[] ProductosMedidas;
    ...
    public ProductosMedidas[] getProductosMedidas() {
        return ProductosMedidas;
    }

    @XmlElement(name = "ProductosMedidas")
    public void setProductosMedidas(ProductosMedidas[] ProductosMedidas) {
        this.ProductosMedidas = ProductosMedidas;
    }
}
