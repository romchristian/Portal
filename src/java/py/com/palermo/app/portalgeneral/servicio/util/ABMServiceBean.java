 ...
 */
package py.com.palermo.app.portalgeneral.servicio.util;
...
import py.com.palermo.app.portalgeneral.modelo.Auditoria;
...
public class ABMServiceBean implements ABMService {
    ...
    @PersistenceContext(unitName = "ServicioMovilPU")
    ...
    public void registrar(Auditable a, String tipoOperacion) {
        ...
        aud.setUsuarioLogeado(credencial.getUsuario() == null ? "" : credencial.getUsuario().getUsername());
        em.persist(aud);
    }
}
